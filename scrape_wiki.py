...
_BULLET_GAME_RE = re.compile(
    ...
    # Score separator allows hyphen / en-dash / em-dash. Hyphen at the
    # start of the character class so it's a literal, not a range operator
    # (otherwise `[–-]` would be a decreasing range from en-dash to hyphen
    # and raise re.error).
